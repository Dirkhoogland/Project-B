                ...
                using (SQLiteCommand cmd = new SQLiteCommand(sql, c))
                {
                    using (SQLiteDataReader rdr = cmd.ExecuteReader())
                    {
                        if (rdr.Read() == false)
                        {
                            ...
                            sql = $"INSERT INTO Tickets(Email, PurchaseTime, Name, Seat, SeatClass, FlightID, UserID, Gate, Departuretime, Destination, Retour, Origin, Extranotes ) VALUES('Email','{time}', 'Dirk','3 - A', 'Business', 1, 1, '11', '{time}', 'Berlin', 'No', 'Amsterdam', '-');";
                            ...
                            sql = $"INSERT INTO Tickets(Email, PurchaseTime, Name, Seat, SeatClass, FlightID, UserID, Gate, Departuretime, Destination, Retour, Origin, Extranotes ) VALUES('Email1','{time}', 'Berat', '2 - A','Business', 1, 2, '11', '{time}','Berlin', 'No', 'Amsterdam', '-');";

                            using (SQLiteCommand cmd1 = new SQLiteCommand(sql, c))
                            {
                                cmd1.ExecuteNonQuery();
                            }
                            sql = $"INSERT INTO Tickets(Email, PurchaseTime, Name,  Seat, SeatClass, FlightID, UserID, Gate, Departuretime, Destination, Retour, Origin, Extranotes ) VALUES('Email','{time}', 'Dirk', '1 - A','Business', 1, 1, '11', '{time}', 'Berlin', 'No', 'Amsterdam', '-');";

                            using (SQLiteCommand cmd1 = new SQLiteCommand(sql, c))
                            {
                                cmd1.ExecuteNonQuery();
                            }
                            sql = $"INSERT INTO Tickets(Email, PurchaseTime, Name,Seat, SeatClass,FlightID, UserID ,Gate, Departuretime, Destination, Retour, Origin, Extranotes) VALUES('Email','{time}', 'Dirk','4 - A','Business', 1, 1, '11', '{time}', 'Berlin', 'No', 'Amsterdam', '-')";

                            using (SQLiteCommand cmd1 = new SQLiteCommand(sql, c))
                            {
                                cmd1.ExecuteNonQuery();
                            }
                            sql = $"INSERT INTO Tickets(Email, PurchaseTime, Name,Seat, SeatClass,FlightID, UserID ,Gate, Departuretime, Destination, Retour, Origin ,Extranotes) VALUES('Email','{time}', 'Dirk','5 - A','Business', 1, 1, '11', '{time}', 'Berlin', 'No', 'Amsterdam', '-');";

                            using (SQLiteCommand cmd1 = new SQLiteCommand(sql, c))
                            {
                                cmd1.ExecuteNonQuery();
                            }
                            sql = $"INSERT INTO Tickets(Email, PurchaseTime, Name,Seat, SeatClass,FlightID, UserID, Gate, Departuretime, Destination, Retour, Origin ,Extranotes) VALUES('Email','{time}', 'Dirk','6 - A','Business', 1, 1, '11', '{time}', 'Berlin', 'No', 'Amsterdam', '-');";
