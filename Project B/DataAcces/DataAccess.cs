                ...
                using (SQLiteCommand cmd = new SQLiteCommand(sql, c))
                {
                    using (SQLiteDataReader rdr = cmd.ExecuteReader())
                    {
                        if (rdr.Read() == false)
                        {
                            ...
                            sql = $"INSERT INTO Tickets(Email, PurchaseTime, Name,Seat, SeatClass,FlightID, UserID ,Gate, Departuretime, Destination, Origin, Extranotes) VALUES('Email','{time}', 'Cirk','4','Business', 1, 1, '11', '{time}', 'Berlin', 'Amsterdam', '-')";

                            using (SQLiteCommand cmd1 = new SQLiteCommand(sql, c))
                            {
                                cmd1.ExecuteNonQuery();
                            }
                            sql = $"INSERT INTO Tickets(Email, PurchaseTime, Name,Seat, SeatClass,FlightID, UserID ,Gate, Departuretime, Destination,Origin ,Extranotes) VALUES('Email','{time}', 'Birk','5','Business', 1, 1, '11', '{time}', 'Berlin', 'Amsterdam', '-');";
                            ...
                            sql = $"INSERT INTO Tickets(Email, PurchaseTime, Name,Seat, SeatClass,FlightID, UserID, Gate, Departuretime, Destination,Origin ,Extranotes) VALUES('Email','{time}', 'Airk','6','Business', 4, 1, '11', '{time}', 'Berlin', 'Amsterdam', '-');";
